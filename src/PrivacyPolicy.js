...
export default function PrivacyPolicy () {
  ...
  >
    ...
    <span className="vcard rich-snippet-hidden">
      <span className="fn">
        <a
          href="https://driftershoots.com/author/james-halldon/"
          title="Posts by James-Halldon"
          rel="author"
        >
          James-Halldon
        </a>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">DrifterShoots</bdt>
              ...
              <span data-custom-class="body_text">
                ...
                contact us at{" "}
                <bdt className="question">driftershoots@gmail.com</bdt>.
              </span>
            </span>
          </span>
        </div>
          ...
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span data-custom-class="body_text">
                ...
                visit our website{" "}
                <bdt className="question">driftershoots.com</bdt> (the “
